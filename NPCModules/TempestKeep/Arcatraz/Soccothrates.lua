...
ThreatLib_funcs[#ThreatLib_funcs+1] = function()
	...
	local SOCCOTHRATES_ID = 20886

	ThreatLib:GetModule("NPCCore"):RegisterModule(SOCCOTHRATES_ID, function(Soccothrates)
		function Soccothrates:Init()
			self:RegisterCombatant(SOCCOTHRATES_ID, true)
