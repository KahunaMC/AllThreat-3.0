...
Website: http://www.wowace.com/wiki/AllThreat-3.0
Documentation: http://www.wowace.com/wiki/AllThreat-3.0
SVN: http://svn.wowace.com/wowace/trunk/AllThreat-3.0/
Description: Tracks and communicates player and pet threat levels
License: LGPL v2.1

Copyright (C) 2007 Chris Heald and the Threat-1.0/AllThreat-3.0 teams
...
ThreatLib.userAgent = "AllThreat-3.0"
...
function ThreatLib:OnInitialize()	
	...
	self.latestSeenRevision = select(2, LibStub("AllThreat-3.0"))
