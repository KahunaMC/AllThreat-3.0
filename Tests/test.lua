...
-- "../../" should work if you run AllThreat-3.0 embedded inside an Omen addon directory
-- "../../Libs/" should work if you run AllThreat-3.0 as a standalone addon
LIB_PATH = "../../Libs/"
--LIB_PATH = "../../"

-- path where AllThreat-3.0.lua etc. reside
ROOT_PATH = "../"
_ACECOMMS = {}
...
function make_threatlib(id, class)
   function loader()
      ...
      -- this list mirrors lib.xml: load AllThreat-3.0 normally
      do_locally("ThreatUtils.lua")
      do_locally("AllThreat-3.0.lua")
      ...
      ThreatLib = LibStub("AllThreat-3.0")

      -- enable AllThreat-3.0 debugging if you wish. need to override its :Debug() though
